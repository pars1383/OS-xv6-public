...
_app_name:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  1c:	e8 72 03 00 00       	call   393 <unlink>
    int fd = open("result.txt", O_CREATE | O_RDWR);
  21:	5b                   	pop    %ebx
  22:	5f                   	pop    %edi
  23:	68 02 02 00 00       	push   $0x202
  28:	68 c8 07 00 00       	push   $0x7c8
  2d:	e8 51 03 00 00       	call   383 <open>
  ...
  3a:	0f 88 92 00 00 00    	js     d2 <main+0xd2>
        exit();
    }
  ...
  49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        ...
        if((int)(argv[1][i]) == 125){
            cnt--;
  50:	80 f9 7d             	cmp    $0x7d,%cl
  53:	0f 94 c1             	sete   %cl
  56:	0f b6 c9             	movzbl %cl,%ecx
  59:	29 cf                	sub    %ecx,%edi
    for(int i = 0; i < strlen(argv[1]); i++){
  5b:	83 c3 01             	add    $0x1,%ebx
  5e:	83 ec 0c             	sub    $0xc,%esp
  61:	50                   	push   %eax
  62:	e8 19 01 00 00       	call   180 <strlen>
  67:	83 c4 10             	add    $0x10,%esp
  6a:	39 d8                	cmp    %ebx,%eax
  6c:	7e 1a                	jle    88 <main+0x88>
        if(cnt < 0){
  6e:	83 ff ff             	cmp    $0xffffffff,%edi
  71:	74 19                	je     8c <main+0x8c>
        if((int)(argv[1][i]) == 123){
  73:	8b 46 04             	mov    0x4(%esi),%eax
  76:	0f b6 0c 18          	movzbl (%eax,%ebx,1),%ecx
  7a:	80 f9 7b             	cmp    $0x7b,%cl
  7d:	75 d1                	jne    50 <main+0x50>
            cnt++;
  7f:	83 c7 01             	add    $0x1,%edi
        if((int)(argv[1][i]) == 125){
  82:	eb d7                	jmp    5b <main+0x5b>
  ...
  8a:	74 31                	je     bd <main+0xbd>
        write (fd, "Wrong\n", 6);
  8c:	50                   	push   %eax
  8d:	6a 06                	push   $0x6
  8f:	68 da 07 00 00       	push   $0x7da
  94:	ff 75 e4             	push   -0x1c(%ebp)
  97:	e8 c7 02 00 00       	call   363 <write>
  ...
  a2:	ff 75 e4             	push   -0x1c(%ebp)
  a5:	e8 c1 02 00 00       	call   36b <close>
    exit();
  ...
  bd:	52                   	push   %edx
  be:	6a 06                	push   $0x6
  c0:	68 d3 07 00 00       	push   $0x7d3
  c5:	ff 75 e4             	push   -0x1c(%ebp)
  c8:	e8 96 02 00 00       	call   363 <write>
  cd:	83 c4 10             	add    $0x10,%esp
  d0:	eb cd                	jmp    9f <main+0x9f>
        printf(2, "strdiff : can not open/create result.txt\n");
  d2:	51                   	push   %ecx
  d3:	51                   	push   %ecx
  d4:	68 e4 07 00 00       	push   $0x7e4
  d9:	6a 02                	push   $0x2
  db:	e8 c0 03 00 00       	call   4a0 <printf>
        exit();
  e0:	e8 5e 02 00 00       	call   343 <exit>
  e5:	83 c4 10             	add    $0x10,%esp
  e8:	e9 53 ff ff ff       	jmp    40 <main+0x40>
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 0e 08 00 00       	mov    $0x80e,%edx
        while(*s != 0){
