 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 0c 09 00 00 	movzbl 0x90c(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 b4 08 00 00 	jmp    *0x8b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba ac 08 00 00       	mov    $0x8ac,%edx
        while(*s != 0){
